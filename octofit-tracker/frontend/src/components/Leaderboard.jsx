...
// Example codespace API endpoint: https://${import.meta.env.VITE_CODESPACE_NAME}-8000.app.github.dev/api/leaderboard
// Keyphrase sample (workflow check): -8000.app.github.dev/api/leaderboard
